---
title: "CEH試験対策：重要用語を体系的に整理する完全ガイド"
emoji: "🔐"
type: "tech"
topics: ["security", "ceh", "pentest", "network", "ethical-hacking"]
published: true
...
CEH（Certified Ethical Hacker）は EC-Council が認定するエシカルハッキングの国際資格です。ペネトレーションテスターや、守る側のセキュリティエンジニアが「攻撃者の視点」を体系的に習得するための登竜門として広く認知されています。

この記事は、**CEH の試験範囲をカバーする重要用語を分野別に構造化した備忘録**です。試験勉強の整理、または実務知識のリファレンスとしてご活用ください。

:::message alert
本記事は個人が調査・学習した内容をまとめたものです。試験仕様は改定されることがあるため、最新情報は EC-Council 公式サイトをご確認ください。
:::
...
| 項目 | 内容 |
|---|---|
| **正式名称** | Certified Ethical Hacker (CEH) |
| **認定機関** | EC-Council |
| **バージョン** | CEH v13（2024年〜） |
| **試験形式** | 125問・多肢選択（MCQ） |
| **試験時間** | 4時間 |
| **合格基準** | 60〜85%（問題セットにより変動） |
| **主要ドメイン数** | 20ドメイン |

CEH v13 からは **AI を活用した攻撃・防御**の内容が大幅に強化されています。

---

## 攻撃の5フェーズ

CEH の根幹となる「ハッキングの5フェーズ」は試験を通じて繰り返し問われます。
...
## ドメイン1：偵察（Reconnaissance / Footprinting）
...
## ドメイン2：スキャン（Scanning & Enumeration）
...
## ドメイン3：システムハッキング（System Hacking）
...
## ドメイン5：ソーシャルエンジニアリング（Social Engineering）
...
## ドメイン13：ペネトレーションテスト（Pen Testing）
