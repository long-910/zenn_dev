---
title: "Zenn記事を自動で中国語翻訳して知乎（Zhihu）に投稿する仕組みを作った"
emoji: "🇨🇳"
type: "tech"
...
しかし、毎回手動で翻訳して投稿するのは面倒です。そこで今回は：
...
Zennと知乎の両方でコンテンツを発信することで、日本語圏と中国語圏の両方の読者にリーチできるようになりました。

同じような仕組みを作りたい方はぜひ参考にしてみてください！
