...
Zenn記事の同期先として GitHub Pages・Qiita・はてなブログ・知乎（Zhihu）の4プラットフォームへの自動投稿を構築してきました。
...
.github/sync-platforms.json   ← ここを編集するだけで同期先を制御
    ...
    └── zhihu.enabled         → auto-post-zhihu.yml
```
...
1. [ZennからZhihu（知乎）自動投稿](https://zenn.dev/long910/articles/2026-03-15-zhihu-auto-posting)
2. [ZennからQiita自動投稿](https://zenn.dev/long910/articles/2026-03-15-qiita-auto-posting)
